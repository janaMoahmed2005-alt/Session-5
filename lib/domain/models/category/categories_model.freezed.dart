...
bool operator ==(Object other) {
  final _this = this as CategoriesResponseModel;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CategoriesResponseModel&&const DeepCollectionEquality().equals(other.categories, _this.categories));
}
...
String toString() {
  final _this = this as CategoriesResponseModel;
  return 'CategoriesResponseModel(categories: ${_this.categories})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? categories = null,}) {
  return _then(CategoriesResponseModel(
...
class _CategoriesResponseModel implements CategoriesResponseModel {
  const _CategoriesResponseModel({required  List<CategoryModel> categories}): _categories = categories;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _CategoriesResponseModel&&const DeepCollectionEquality().equals(other.categories, _categories));
}

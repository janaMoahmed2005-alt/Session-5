...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnBoardingItem> _pages = const [
    OnBoardingItem(
      image: 'https://img.magnific.com/premium-vector/blue-diamond-gem_410429-24992.jpg',
      title: 'Discover Your Style',
      description:
          'Explore a beautiful collection of rings, necklaces, bracelets, charms, and more—made to match your unique style.',
    ),
    OnBoardingItem(
      image: 'https://cdn-icons-png.flaticon.com/512/5040/5040984.png',
    ...
    OnBoardingItem(
        image:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYi4qjDFaiNZmc0HkjscLeFlJFunhFmmoJCPmjlPZ8TRzakvXKO9r1RiXR&s=10',
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          flex: 5,
                          child: Center(
                            child: page.image.startsWith('http')
                                ? Image.network(
                                    page.image,
                                    fit: BoxFit.contain,
                                  )

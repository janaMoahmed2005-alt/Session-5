...
import 'package:flutter_application_1/presentation/cubit/category/category_state.dart';
...
class _ProductScreenState extends State<ProductScreen> {
        ...
        return Scaffold(
          ...
          body: BlocBuilder<ProductCubit, ProductState>(
            builder: (context, state) {
              return switch (state) {
                ProductInitialState() || ProductLoadingState() => Center(
                ...
                ProductSuccessState(:final products) => ListView(
  ...
  builder: (context, categoryState) {
    return switch (categoryState) {
      CategoriesInitialState() || CategoriesLoadingState() => const SizedBox(
        height: 40,
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    ...
                    // Product List — iterate the domain list directly
                    ...products.map(
                      (product) => Padding(
